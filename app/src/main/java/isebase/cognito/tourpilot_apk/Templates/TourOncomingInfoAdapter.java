...
import isebase.cognito.tourpilot_apk.Data.TourOncomingInfo.TourOncomingInfo.TourOncomingInfoDayPart;
import isebase.cognito.tourpilot_apk.Data.TourOncomingInfo.TourOncomingInfo.TourOncomingInfoWoker;
	...
	public View getChildView(final int groupPosition, final int childPosition,
		...
		if (convertView == null) {
			convertView = inflater
					.inflate(
							isebase.cognito.tourpilot_apk.R.layout.row_braden_answer_template,
							null);
		}

		TextView item = (TextView) convertView
				.findViewById(isebase.cognito.tourpilot_apk.R.id.tvBradenAnswer);
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if (convertView == null) {
			...
			convertView = infalInflater
					.inflate(
							isebase.cognito.tourpilot_apk.R.layout.row_braden_question_template,
							null);
		}
		TextView item = (TextView) convertView
				.findViewById(isebase.cognito.tourpilot_apk.R.id.tvBradenQuestion);
